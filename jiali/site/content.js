...
window.CONTENT = {
  artist: {
    name_zh: "奉家丽", name_en: "Feng Jiali",
    born_zh: "1963 年生于重庆", born_en: "Born 1963, Chongqing",
    based_zh: "工作生活于 北京 · 贵州 · 纽约", based_en: "Lives and works in Beijing, Guizhou and New York",
    email: "jialistudio2963@gmail.com",
    instagram: "https://www.instagram.com/jialistudio/", wechat: "fengjiali76",
    tagline_zh: "以女性主义视角，叩问生命、记忆与历史。",
    tagline_en: "A feminist artist asking after life, memory and history.",
    bio_zh: "奉家丽，1963 年生于重庆。1990 年毕业于四川美术学院油画系，获文学学士学位；1993 年完成中央美术学院第六届油画研修班。九十年代末，她成为北京东村艺术群落的一员。她的创作横跨绘画、行为、装置与大地艺术。三十年来，她持续追问女性经验、身体叙事、身份建构，以及人与自然的关系。1998 年，她在北京成立「塞壬艺术工作室」。她的展览遍及纽约、巴塞尔、卢森堡、德国、布拉格、南非、布达佩斯、古巴、香港、澳门与中国各地。曾获《世纪·女性》艺术展女性艺术学社奖（1998）、第十二届全国美展提名奖（2014）、女性艺术双年展学术奖（2015），以及 Celia & Wally Gilbert 驻地奖（2025）。",
  ...
  cv: {
    awards: [
      {y:"1998", after:"fenlian", zh:"《世纪·女性》艺术展女性艺术学社奖", en:"Academic Award, Century Women Art Exhibition"},
      {y:"2014", after:"hubo", zh:"第十二届全国美展获奖提名奖", en:"Nomination Award, 12th National Art Exhibition of China"},
      {y:"2015", after:"fumei", zh:"女性艺术双年展学术奖", en:"Academic Award, Women's Art Biennale"},
      {y:"2025", after:"langji", zh:"Celia & Wally Gilbert 驻地艺术家", en:"Celia & Wally Gilbert Artist-in-Residence"}
    ],
    solo: [
      {y:"2018 to 2025", zh:"艺术美学空间「乡拉岜」个人项目", en:"Xianglaba Aesthetic Space, personal project"},
      {y:"2025", zh:"《复魅草案》下苑当代艺术中心，北京", en:"The Draft of Re-enchantment, Xia Yuan Contemporary Art Center, Beijing"},
      {y:"2024", zh:"《浪迹》角声艺术中心 · 法拉盛公共图书馆，纽约", en:"Wandering, KJ Art Center and Flushing Public Library, New York"},
      {y:"2022", zh:"《十月·稻田装置大地艺术》洪江田野，荔波", en:"October, Rice Field Land Art Installation, Libo"},
      {y:"2020", zh:"《与我一起》国际女性主义艺术线上连续个展", en:"With Me, international feminist art online series"},
      {y:"2019", zh:"《自然复魅》汉威国际艺术中心，北京", en:"Re-enchantment of Nature, Hanwei International Art Center, Beijing"},
      {y:"2018", zh:"《墓园》黑空间，北京 · 《领襟行动》行为", en:"The Cemetery, Black Space, Beijing. Collar Action, performance"},
      {y:"2017", zh:"《身份》送给歌诗的成人礼物，北京", en:"Identity, a coming-of-age gift for Songshi, Beijing"},
      {y:"2010", zh:"《闺秘·奉家丽油画新作展》环铁时代美术馆，北京", en:"Inner Chamber, New Oil Paintings, Huantie Times Art Museum, Beijing"},
      {y:"2003", zh:"《奉家丽手工与媒材艺术展》久久画廊，德国", en:"Handcraft and Material Art, Galerie 99, Germany"},
      {y:"1999", zh:"《奉家丽油画艺术展》四合苑画廊，北京", en:"Oil Painting Exhibition, Sihaiyuan Gallery, Beijing"},
      {y:"1996", zh:"《桃花祭》行为作品，妙峰山，北京", en:"Peach Blossom Ritual, performance, Miaofeng Mountain"},
      {y:"1994", zh:"《猫》行为作品，成都", en:"Cat, performance, Chengdu"}
    ],
    group: [
      {y:"2025", zh:"《ART’25 时光的裂隙·十年变迁她的眼睛》AAP-Gallery，巴塞尔", en:"ART’25: Cracks of Time, AAP Gallery, Basel"},
      {y:"2024", zh:"《风·呼吸·水》华裔艺术家声音与视觉艺术展，Howlang Culture Center，纽约", en:"Wind, Breath, Water, Howlang Culture Center, New York"},
      {y:"2023", zh:"《跨越与融通·中国当代艺术展》萨拉鲁埃国家展览馆，萨尔瓦多", en:"Crossing and Integration, El Salvador National Exhibition Hall"},
      {y:"2022", zh:"第14届哈瓦那双年展，古巴国家图书馆，古巴", en:"The 14th Havana Biennial, Cuba National Library"},
      {y:"2019", zh:"中国当代艺术展，布达佩斯 · 中国与南非对话，德班美术馆", en:"Chinese Contemporary Art, Budapest. China and South Africa Dialogue, Durban Art Museum"},
      {y:"2017", zh:"首届中欧布拉格国际双年展，布拉格", en:"First Prague International Biennale, Prague"},
      {y:"2014", zh:"第十二届全国美展·综合材料绘画作品展，中国美术馆", en:"12th National Art Exhibition, Mixed Media Painting, China Art Museum"},
      {y:"2009", zh:"《叙事中国·第四届成都双年展》成都", en:"Narrative China, 4th Chengdu Biennale, Chengdu"},
      {y:"2008", zh:"Art Basel Miami 项目，迈阿密", en:"Art Basel Miami Project, Miami"},
      {y:"2000", zh:"ART/OMI 国际艺术家驻访、创作与展览，纽约", en:"ART/OMI International Residency and Exhibition, New York"},
      {y:"1998", zh:"《世纪·女性》藏品展，中国美术馆 · 成立「塞壬艺术工作室」", en:"Century Women Exhibition, National Art Museum of China. Founded the Siren Studio"},
      {y:"1989", zh:"《四人油画联展》四川美术学院陈列馆，重庆", en:"Four-Person Oil Painting Exhibition, Sichuan Fine Arts Institute, Chongqing"}
    ]
  },

  // Series descriptions (override data.js). Dash-free, grounded in the artist's statements.
  seriesDesc: {
    fenlian:{zh:"艳俗浓妆的女性面孔，戏仿宣传画里红润的双颊。以艳俗的形与色，温和地嘲讽消费时代被客体化的女性身体。这是奉家丽女性主义绘画的起点。",
    ...
    shougong:{zh:"追忆手工上彩照相馆时代的女性形象。泛黄的底色上，脂粉与目光打捞起一个被遗忘时代的温度。",
    ...
    guimi:{zh:"少女、红领巾、鸟巢与折纸鹤。在蓝灰的色调里，「时刻准备着」的集体记忆被重新凝视。青春、规训，以及隐秘的欲望。",
    ...
    hubo:{zh:"综合材料的微观凝固，像琥珀封存了时间。拓印、女红与植物标本交织在一起，是她从绘画走向自然与手工的转折。",
    ...
    shenfen:{zh:"送给女儿歌诗的成人礼物。蝉蜕之变，身份的脱壳与重生，以综合材料写下一场女性生命的过渡仪式。",
    ...
    muyuan:{zh:"高 2 米、长 19 米的巨幅油画，重构重庆沙坪坝的红卫兵墓园。奉家丽自幼在墓园旁长大，历时两年揭开一段被遮蔽的历史。她说，这不是关于政治立场，而是关于生命：青春如何被时代的浪潮卷走。完成之后，她大病一场。",
    ...
    shixu:{zh:"《墓园》之后的延伸。凝重、晦暗、浑厚的石墟，以废墟的美学作证：那些依附于意识形态的「人化自然」，终归化为废墟。",
    ...
    fumei:{zh:"在拓印的长卷上以针线作画，野草、本草、花虫尽收其中。她从女性主义走向后女性主义与生态关怀，以「破坏性创造力」复魅自然的本真。展览现场尤为精彩，值得亲见。",
    ...
    cangsheng:{zh:"疫情期间的小幅油画。口罩之下的面孔，伤感的大红。它们记下一个集体屏息的年份里，每一个苍生的脆弱与坚持。",
    ...
    lingjin:{zh:"行为作品。边角与衣襟里的记忆，以身体和布料的行动，叩问女性日常劳作中被忽略的价值。",
    ...
    dadi:{zh:"《向稻谷致敬》是荔波的稻田装置，《克莉丝蒂娜的教堂》是长岛复活节的大地艺术。她把创作交还给土地与季节，向最朴素的生长致敬。",
    ...
    langji:{zh:"2024 年纽约个展（角声艺术中心、法拉盛公共图书馆）。综合媒材的漂泊之书，记下一个艺术家在北京、贵州与纽约之间的迁徙与扎根。",
    ...
    photo:{zh:"《妊娠就是艺术》与《女殇》系列。出于对作品的保护，摄影作品在此以模糊呈现。如需观看，请邮件联系艺术家。",
    ...
    xiaowanglu:{zh:"一只搪瓷痰盂，盆身画上一张浓妆的女性面孔。日用的污秽之器，与被观看的女性面容并置。笑与忘之间，是身体被使用、又被遗忘的处境。",
    ...
    xiaoxia:{zh:"系列之名来自一个残酷的古老故事。魏文帝爱妾夜来深夜误撞水晶屏风，血染面颊，文帝却赞为「晓霞将散」，宫人于是以胭脂仿画，名「晓霞妆」。女性的鲜血与痛苦，自古被当作帝王文人产生「美感」的玩物。作品画在旧牛仔衣裤上，缀以丝线、纽扣、花边、珊瑚、发卡。",
    ...
    kouzhao:{zh:"她把原先的天使系列搁置，落笔于再日常不过、却又非常的口罩。口罩超越了它的审美属性，朝向真实与真相，赤裸出生命政治的意义。口罩将被时间记入历史，而还有什么比这一几乎被遗忘的细节，更能举证历史、记忆历史。",
    ...
    xiaoyouhua:{zh:"2021 至 2025 年的小幅油画。在大叙事之外，她回到尺幅之间的日常凝视，画身边的人与物，画一段安静的近作时光。",
  ...
  press: [
    {by_zh:"夏可君", by_en:"Xia Kejun",
     zh:"在当代中国女艺术家中，没有人比奉家丽对女性的生命与形象有着最为自觉与反省的思考。她对女性丰富多变形象的塑造挑战了我们的凝视，也纠正了视觉的暴力。",
    ...
    {by_zh:"贾方舟", by_en:"Jia Fangzhou",
     zh:"奉家丽自上世纪 90 年代以来一直是绘画领域中女性主义的积极推动者。她运用包括身体在内的多种媒介，严肃思考长期被男权遮蔽的女性生存处境。",
    ...
    {by_zh:"江梅", by_en:"Jiang Mei",
     zh:"她一以贯之坚持鲜明的女性主义立场，试图用女性的美好特质改变男性主流价值，使她成为当代中国女艺术家中极具个性色彩与叛逆精神的一个。",
    ...
    {by_zh:"水天中", by_en:"Shui Tianzhong",
     zh:"奉家丽属于实践女性主义艺术的「塞壬」艺术工作室。艳俗的形、色和特殊的选材，共同构成对当代女性生存状态的温和嘲讽。",
  ...
  essays: [
    {
      ...
      title_zh:"无边的差异，永恒的女性", title_en:"Boundless Difference, Eternal Femininity",
      meta_zh:"奉家丽 自述 · 答策展人林似竹（Britta Erickson）· 1999",
      meta_en:"Feng Jiali, in answer to curator Britta Erickson, 1999",
      body_zh:["我承认自己是一个浪漫型的女性主义艺术家。从幻想回到现实，我首先坚持差异的观点。正是差异性使多元化的世界显现出多样性和丰富性，即使在女性主义内部，差异性也依然是其非本质主义的本质特性。",
        "女性主义艺术不只是要求享有人类的完整权利，而是更注重差异性的完整体现。",
        "从大学到研究班，我的油画专业成绩都是优秀的。但因为我是女性，又不肯依附于某种权力背景，就找不到一份与艺术相关的工作。如此，我选择了自我定义的「职业艺术家」。我的护照上职业栏被写着「无业人员」。",
        "只有当人类学会用女性的艺术精神去思考、感觉、反省，这个地球才有免予毁灭的希望。我们之所以相信未来，是因为未来属于现在，同时也属于过去；而这三者，都取决于我们女性的自主。"],
    ...
    },
    {
      ...
      title_zh:"揭开历史的一角：奉家丽的巨幅油画《墓园》", title_en:"Unveiling a Corner of History: Feng Jiali's The Cemetery",
      meta_zh:"王家新 诗人、批评家、中国人民大学教授 · 2026", meta_en:"Wang Jiaxin, poet and critic, professor at Renmin University, 2026",
    ...
    },
    {
      ...
      title_zh:"自荐信 · 《墓园》收藏提案", title_en:"Letter of Recommendation, Proposal for Acquisition",
      meta_zh:"奉家丽 致美术馆馆长与策展委员会", meta_en:"Feng Jiali, to museum directors and curatorial committees",
    ...
    },
    {
      ...
      title_zh:"以自然复魅重构风景诗学", title_en:"Re-enchanting Nature, Rebuilding a Poetics of Landscape",
      meta_zh:"岛子 评《自然复魅》· 己亥年，京北上苑", meta_en:"Daozi, on Re-enchantment of Nature, Shangyuan, Beijing",
      body_zh:["2015 年以来，奉家丽在油画和综合材料实验两个领域持续创作。在推出大型油画《墓园》的同时，她完成了系列综合材料作品《自然复魅》。其主题关乎自然，其旨趣寄寓生态的质询与关怀。",
        "以针作画，是传统的刺绣工艺。但在奉的手里，复制性的工艺趣味已被审慎地离析、解构并合理转换，可以说是一种「去刺绣」的实验。她把线描笔线转换为针线、针脚的运动，以针法替代水墨的「骨法用笔」。",
        "野生草木、花卉草虫、中药本草尽被收拾囊中，画室几乎变成植物标本陈列室。这一「述行」，旨在复魅自然本真，断然摈除那种将自然对象化的因袭。",
        "发展主义对自然的「创造性破坏」，只能付诸于艺术的、审美的「破坏性创造力」形式来对决，履行文化主体根性的复原并加以永续葆守。"],
    ...
    },
    {
      ...
      title_zh:"后女性主义：水库石壁上的拓印", title_en:"Post-Feminism: Rubbings on the Reservoir Wall",
      meta_zh:"Christopher Pelley · 罗马，2019", meta_en:"Christopher Pelley, Rome, 2019",
